...
#include <memory>
#include "../../../src/Denoising/parametersetwidget.h"
...
QT_INIT_METAOBJECT const QMetaObject ParameterWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_ParameterWidget.data,
...
void ParameterSetWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ParameterSetWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ParameterSetWidget::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ParameterSetWidget::ReadyToApply)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ParameterSetWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ParameterSetWidget::TransToNoisyMesh)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ParameterSetWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ParameterSetWidget::TransToOriginalMesh)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (ParameterSetWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ParameterSetWidget::TransToDenoisedMesh)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ParameterSetWidget::staticMetaObject = { {
    &QDockWidget::staticMetaObject,
    qt_meta_stringdata_ParameterSetWidget.data,
    qt_meta_data_ParameterSetWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
