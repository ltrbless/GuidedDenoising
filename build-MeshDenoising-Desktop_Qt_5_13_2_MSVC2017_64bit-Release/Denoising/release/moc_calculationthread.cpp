...
#include <memory>
#include "../../../src/Denoising/calculationthread.h"
...
void CalculationThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CalculationThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CalculationThread::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CalculationThread::needToUpdateGL)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CalculationThread::*)(bool , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CalculationThread::setActionAndWidget)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (CalculationThread::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CalculationThread::statusShowMessage)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CalculationThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_CalculationThread.data,
    qt_meta_data_CalculationThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
