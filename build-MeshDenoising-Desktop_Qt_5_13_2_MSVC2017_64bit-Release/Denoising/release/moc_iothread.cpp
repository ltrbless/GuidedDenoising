...
#include <memory>
#include "../../../src/Denoising/iothread.h"
...
void ioThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ioThread::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ioThread::statusShowMessage)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ioThread::*)(bool , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ioThread::setActionAndWidget)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ioThread::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ioThread::needToUpdateGL)) {
                *result = 2;
                return;
            }
        }
